...
🎸 Strumming chords while CI pipelines pass (multitasking at its finest)`;
  ...
  return (
    <section id="about" className="min-h-screen bg-black rounded-b-4xl">
      ...
      />
      <div className="flex flex-col items-center justify-between gap-16 px-10 pb-16 text-xl font-light tracking-wide lg:flex-row md:text-2xl lg:text-3xl text-[#C6A265]/60">
        <img
          ref={imgRef}
          src="images/man.jpg"
          alt="man"
